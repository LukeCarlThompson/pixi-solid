...
The `usePixiApp` hook provides a way to access the root `PIXI.Application` instance created by the `<PixiApplication />` component.
...
```tsx
import { usePixiApp, Container } from "pixi-solid";
