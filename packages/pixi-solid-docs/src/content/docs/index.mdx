---
title: Pixi Solid
description: Docs and examples for Pixi Solid. A way to work with PixiJS inside SolidJS.
template: splash # Remove or comment out this line to display the site sidebar on this page.
hero:
  tagline: Docs and examples for Pixi Solid. A way to work with PixiJS inside SolidJS.
  image:
