import{q as y,p as P,x as c,y as d,z as p,D as T}from"./pixi-stage.DpA0Rhvt.js";import{F as b}from"./Filter.QaxDQ2CO.js";const m={5:[.153388,.221461,.250301],7:[.071303,.131514,.189879,.214607],9:[.028532,.067234,.124009,.179044,.20236],11:[.0093,.028002,.065984,.121703,.175713,.198596],13:[.002406,.009255,.027867,.065666,.121117,.174868,.197641],15:[489e-6,.002403,.009246,.02784,.065602,.120999,.174697,.197448]},z=["in vec2 vBlurTexCoords[%size%];","uniform sampler2D uTexture;","out vec4 finalColor;","void main(void)","{","    finalColor = vec4(0.0);","    %blur%","}"].join(`
`);function B(s){const t=m[s],e=t.length;let r=z,u="";const l="finalColor += texture(uTexture, vBlurTexCoords[%index%]) * %value%;";let i;for(let n=0;n<s;n++){let a=l.replace("%index%",n.toString());i=n,n>=e&&(i=s-n-1),a=a.replace("%value%",t[i].toString()),u+=a,u+=`
...
`}return r=r.replace("%blur%",u),r=r.replace("%size%",s.toString()),r=r.replace("%dimension%",t?"z":"w"),r}function Y(s,t){const e=X(t,s),r=B(t);return y.from({vertex:e,fragment:r,name:`blur-${s?"horizontal":"vertical"}-pass-filter`})}var C=`
