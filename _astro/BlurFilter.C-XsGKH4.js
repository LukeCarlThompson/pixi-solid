import{o as S,n as P,E as f,I as b,J as c,K as T}from"./pixi-canvas.BnPUkR0E.js";import{F as m}from"./Filter.CdnVFp13.js";const x={5:[.153388,.221461,.250301],7:[.071303,.131514,.189879,.214607],9:[.028532,.067234,.124009,.179044,.20236],11:[.0093,.028002,.065984,.121703,.175713,.198596],13:[.002406,.009255,.027867,.065666,.121117,.174868,.197641],15:[489e-6,.002403,.009246,.02784,.065602,.120999,.174697,.197448]},B=["in vec2 vBlurTexCoords[%size%];","uniform sampler2D uTexture;","out vec4 finalColor;","void main(void)","{","    %blur%","}"].join(`
`);function z(o){const t=x[o],e=t.length;let r="";const s="finalColor = ",l="    + ",n="texture(uTexture, vBlurTexCoords[%index%]) * %value%";for(let i=0;i<o;i++){const p=i===0?s:l,h=i<e?i:o-i-1,a=n.replace("%index%",i.toString()).replace("%value%",t[h].toString());r+=`${p}${a}
`}return B.replace("%blur%",`${r};`).replace("%size%",o.toString())}const O=`
    in vec2 aPosition;
...
`}return r=r.replace("%blur%",s),r=r.replace("%size%",o.toString()),r=r.replace("%dimension%",t?"z":"w"),r}function X(o,t){const e=_(t,o),r=z(t);return S.from({vertex:e,fragment:r,name:`blur-${o?"horizontal":"vertical"}-pass-filter`})}var Y=`
