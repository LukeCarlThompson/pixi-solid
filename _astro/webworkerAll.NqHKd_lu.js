import{V as f,U as Ie,O as j,o as ie,p as oe,ab as v,a9 as C,a4 as ue,I as T,j as P,aM as le,J as X,X as E,aw as ce,n as B,au as G,aT as Oe,aU as H,az as L,aV as F,a3 as N,a2 as R,m as $,E as Ve,T as W,aW as Ee,ac as de,af as he,aO as fe,aR as pe,aX as me,ad as Le,ae as We,aP as Ye,aQ as Ke,aS as Xe,k as He,aY as $e,aZ as qe,am as Y,a_ as je,a$ as Ne,a0 as xe,aa as ge,b0 as Qe,b1 as Je,K as Q,b2 as J,b3 as D,Y as x,b4 as Ze}from"./components.DgSislmX.js";import{c as M,a as et,b as tt,B as _e}from"./colorToUniform.BXaCBwVl.js";import{F as rt}from"./Filter.lScg75E_.js";import"./web.CaR6HTnT.js";import"./solid.CQt0tiR7.js";import"./store.DS17IrOM.js";import"./preload-helper.BXH4tTM1.js";class be{static init(e){Object.defineProperty(this,"resizeTo",{configurable:!0,set(t){globalThis.removeEventListener("resize",this.queueResize),this._resizeTo=t,t&&(globalThis.addEventListener("resize",this.queueResize),this.resize())},get(){return this._resizeTo}}),this.queueResize=()=>{this._resizeTo&&(this._cancelResize(),this._resizeId=requestAnimationFrame(()=>this.resize()))},this._cancelResize=()=>{this._resizeId&&(cancelAnimationFrame(this._resizeId),this._resizeId=null)},this.resize=()=>{if(!this._resizeTo)return;this._cancelResize();let t,r;if(this._resizeTo===globalThis.window)t=globalThis.innerWidth,r=globalThis.innerHeight;else{const{clientWidth:n,clientHeight:a}=this._resizeTo;t=n,r=a}this.renderer.resize(t,r),this.render()},this._resizeId=null,this._resizeTo=null,this.resizeTo=e.resizeTo||null}static destroy(){globalThis.removeEventListener("resize",this.queueResize),this._cancelResize(),this._cancelResize=null,this.queueResize=null,this.resizeTo=null,this.resize=null}}be.extension=f.Application;class ye{static init(e){e=Object.assign({autoStart:!0,sharedTicker:!1},e),Object.defineProperty(this,"ticker",{configurable:!0,set(t){this._ticker&&this._ticker.remove(this.render,this),this._ticker=t,t&&t.add(this.render,this,Ie.LOW)},get(){return this._ticker}}),this.stop=()=>{this._ticker.stop()},this.start=()=>{this._ticker.start()},this._ticker=null,this.ticker=e.sharedTicker?j.shared:new j,e.autoStart&&this.start()}static destroy(){if(this._ticker){const e=this._ticker;this.ticker=null,e.destroy()}}}ye.extension=f.Application;var nt=`in vec2 aPosition;
