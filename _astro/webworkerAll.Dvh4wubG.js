import{Q as f,U as Ie,L as N,o as ie,p as oe,aa as v,a8 as C,a3 as ue,E as T,j as P,aL as le,I as X,W as E,av as ce,n as B,at as G,aS as Oe,aT as H,ay as L,aU as F,a2 as j,a1 as R,m as $,v as Ve,T as W,aV as Ee,ab as de,ae as he,aN as fe,aQ as pe,aW as me,ac as Le,ad as We,aO as Ye,aP as Ke,aR as Xe,k as He,aX as $e,aY as qe,al as Y,aZ as Ne,a_ as je,$ as xe,a9 as ge,a$ as Qe,b0 as Je,J as Q,b1 as J,b2 as z,X as x,b3 as Ze}from"./pixi-components.C0LWeWT1.js";import{c as M,a as et,b as tt,B as _e}from"./colorToUniform.BXaCBwVl.js";import{F as rt}from"./Filter.D0EUPz1D.js";import"./web.Cr4611hB.js";import"./solid.BNQBajBB.js";import"./store.BHICbBK7.js";import"./preload-helper.BXH4tTM1.js";class be{static init(e){Object.defineProperty(this,"resizeTo",{configurable:!0,set(t){globalThis.removeEventListener("resize",this.queueResize),this._resizeTo=t,t&&(globalThis.addEventListener("resize",this.queueResize),this.resize())},get(){return this._resizeTo}}),this.queueResize=()=>{this._resizeTo&&(this._cancelResize(),this._resizeId=requestAnimationFrame(()=>this.resize()))},this._cancelResize=()=>{this._resizeId&&(cancelAnimationFrame(this._resizeId),this._resizeId=null)},this.resize=()=>{if(!this._resizeTo)return;this._cancelResize();let t,r;if(this._resizeTo===globalThis.window)t=globalThis.innerWidth,r=globalThis.innerHeight;else{const{clientWidth:n,clientHeight:a}=this._resizeTo;t=n,r=a}this.renderer.resize(t,r),this.render()},this._resizeId=null,this._resizeTo=null,this.resizeTo=e.resizeTo||null}static destroy(){globalThis.removeEventListener("resize",this.queueResize),this._cancelResize(),this._cancelResize=null,this.queueResize=null,this.resizeTo=null,this.resize=null}}be.extension=f.Application;class ye{static init(e){e=Object.assign({autoStart:!0,sharedTicker:!1},e),Object.defineProperty(this,"ticker",{configurable:!0,set(t){this._ticker&&this._ticker.remove(this.render,this),this._ticker=t,t&&t.add(this.render,this,Ie.LOW)},get(){return this._ticker}}),this.stop=()=>{this._ticker.stop()},this.start=()=>{this._ticker.start()},this._ticker=null,this.ticker=e.sharedTicker?N.shared:new N,e.autoStart&&this.start()}static destroy(){if(this._ticker){const e=this._ticker;this.ticker=null,e.destroy()}}}ye.extension=f.Application;var nt=`in vec2 aPosition;
