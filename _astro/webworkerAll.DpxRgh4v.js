import{Y as f,W as Ie,V as j,n as ie,p as oe,ae as v,ac as C,a7 as ue,L as T,j as P,aP as le,O as H,_ as E,az as ce,m as B,ax as G,aW as Oe,aX as X,aC as L,aY as F,a6 as N,a5 as R,l as $,K as Ve,T as W,aZ as Ee,af as de,ai as he,aR as fe,aU as pe,a_ as me,ag as Le,ah as We,aS as Ye,aT as Ke,aV as He,k as Xe,a$ as $e,b0 as qe,ap as Y,b1 as je,b2 as Ne,a3 as xe,ad as ge,b3 as Qe,b4 as Ze,Q,b5 as Z,b6 as D,$ as x,b7 as Je}from"./pixi-stage.Cw0gQut1.js";import{c as M,a as et,b as tt,B as _e}from"./colorToUniform.BXaCBwVl.js";import{F as rt}from"./Filter.DHmuKXWM.js";import"./web.CDgPdljw.js";import"./solid.BSWr5Iuq.js";import"./preload-helper.BXH4tTM1.js";import"./store.BpsTmRgj.js";class be{static init(e){Object.defineProperty(this,"resizeTo",{configurable:!0,set(t){globalThis.removeEventListener("resize",this.queueResize),this._resizeTo=t,t&&(globalThis.addEventListener("resize",this.queueResize),this.resize())},get(){return this._resizeTo}}),this.queueResize=()=>{this._resizeTo&&(this._cancelResize(),this._resizeId=requestAnimationFrame(()=>this.resize()))},this._cancelResize=()=>{this._resizeId&&(cancelAnimationFrame(this._resizeId),this._resizeId=null)},this.resize=()=>{if(!this._resizeTo)return;this._cancelResize();let t,r;if(this._resizeTo===globalThis.window)t=globalThis.innerWidth,r=globalThis.innerHeight;else{const{clientWidth:n,clientHeight:a}=this._resizeTo;t=n,r=a}this.renderer.resize(t,r),this.render()},this._resizeId=null,this._resizeTo=null,this.resizeTo=e.resizeTo||null}static destroy(){globalThis.removeEventListener("resize",this.queueResize),this._cancelResize(),this._cancelResize=null,this.queueResize=null,this.resizeTo=null,this.resize=null}}be.extension=f.Application;class ye{static init(e){e=Object.assign({autoStart:!0,sharedTicker:!1},e),Object.defineProperty(this,"ticker",{configurable:!0,set(t){this._ticker&&this._ticker.remove(this.render,this),this._ticker=t,t&&t.add(this.render,this,Ie.LOW)},get(){return this._ticker}}),this.stop=()=>{this._ticker.stop()},this.start=()=>{this._ticker.start()},this._ticker=null,this.ticker=e.sharedTicker?j.shared:new j,e.autoStart&&this.start()}static destroy(){if(this._ticker){const e=this._ticker;this.ticker=null,e.destroy()}}}ye.extension=f.Application;var nt=`in vec2 aPosition;
